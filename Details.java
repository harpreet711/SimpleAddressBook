...
public class Details implements Operations {

	private List<SimpleAddressBook> addressBooks;

	public Details() {
		addressBooks = new ArrayList<SimpleAddressBook>();
		addressBooks.add(new SimpleAddressBook("1", new ArrayList<Person>()));
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Enter 1 to open address book");
	...
	private static boolean doesAddressBookExist(Details books, String bookID) {
		for (SimpleAddressBook b : books.addressBooks) {
	...
	public void createPerson(String bookID) {
		...
		for (SimpleAddressBook b : addressBooks) {
			if (b.getBookID().equals(bookID)) {
